 ...
 *
*/
#ifndef LIGHTSENSOR_HH_
#define LIGHTSENSOR_HH_
...
namespace custom
{
  ...
  /// robot, with noise.
  class LightSensor : public ignition::sensors::Sensor
  {
    ...
    /// \brief Set the current postiion of the robot, so the light_sensor can
    ...
    /// \return The latest position given to the light_sensor.
